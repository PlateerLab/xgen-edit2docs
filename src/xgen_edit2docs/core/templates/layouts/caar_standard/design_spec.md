...
| -------------- | ---------------------------------------------------------- |
| **Template Name** | caar_standard (formerly zhongqiyan)                       |
...
2. **Asset Replacement**: Replace `large_logo.png` (592×238) and `top_right_logo.png` (113×50) in the `images` directory.
