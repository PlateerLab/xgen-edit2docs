...
| `logo_dark.png` | 「cmb_bank \| 公司金融」dark logo for light page headers |
...
| `logo_crm_banner.png` | 「cmb_bank \| CRM 4.0」red banner (product-specific, use when applicable) |
